...
const UpdateBlog = () => {
    ...
    const UpdateBlog = async () => {
        try {
            ...
            const response = await fetch(`${myAPI}/blogs/${blogdetail._id}`, {
                method: 'PUT',
    ...
    return (
        <>
            <ScrollPanel style={{ height: '100vh' }}>
                <MDBContainer >
                    <MDBRow >
                        <h3 className='mt-3 text-start ' >Update Blog</h3>
                    </MDBRow>
                    <MDBRow  className='d-flex flex-column ' >
                        ...
                        <MDBCol size='md-10' className='mt-3' >
                            ...
                            <div className="d-flex  w-50 ">
                                <MDBBtn className='w-25 mt-3' onClick={UpdateBlog} >Update</MDBBtn>
                            </div>
                        </MDBCol>
                    </MDBRow>
                </MDBContainer>
